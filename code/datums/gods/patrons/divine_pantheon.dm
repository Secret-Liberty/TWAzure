...
/datum/patron/divine/undivided
	...
	miracles = list(/obj/effect/proc_holder/spell/targeted/touch/orison			= CLERIC_ORI,
					/obj/effect/proc_holder/spell/invoked/ignition				= CLERIC_T0, // ONLY Lower miracles of other lists + Heal/Revive. A much more varied miracle list, and a much wider selection. But no specialization makes a lower level list. We're going to exclude Dendor/Abyssor.
					...
					/obj/effect/proc_holder/spell/invoked/conjure_tool			= CLERIC_T2,
